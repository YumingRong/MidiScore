...
{
    public partial class MidiInPanel : Form
    {
        MidiIn midiIn;
        MidiOut midiOut;
        bool monitoring;
        ...
        private void MidiInPanel_Load(object sender, EventArgs e)
        {
        ...
        private void MidiInPanel_FormClosed(object sender, FormClosedEventArgs e)
        {
